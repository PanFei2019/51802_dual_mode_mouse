...
nrfjprog --program "aa_nrf51822_xxac_with_bootloader_setting.hex" --sectorerase --family NRF51
nrfjprog --verify "aa_nrf51822_xxac_with_bootloader_setting.hex" --family NRF51
